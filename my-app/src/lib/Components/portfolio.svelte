		...
		<section class="Fly-Menu">
			<div class="Container" transition:fly={{ delay: 500, duration: 500 }}>
				<div class="Information-Menu">
					{#if selectedOffer}
						<div class="Title"><h2>{selectedOffer.Tittle}</h2></div>
						<div class="Photo"><img class="Size" src={selectedOffer.src} alt="" /></div>
			...
			<div class="Content">
				<div class="Projects">
					{#each oferty as oferta}
						<div class="test">
							<img class="Size" src={oferta.src} alt="" on:click={() => OpenMenu(oferta)} />
						</div>
					{/each}
				</div>
			</div>
